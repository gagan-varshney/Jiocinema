...
export default function Home()
{
    ...
    let [usamovies, setUsaMovies] = useState([])
    ...
    useEffect(async ()=>{
        ...
        try 
        {
            ...
            setDramaMovies(draMovies.slice(0,6))
             ...
             let usamovies = moviesData.filter((movie)=>{return movie.country==="USA"})
             setUsaMovies(usamovies.slice(6,12))

             let japaneseMovie = moviesData.filter((movie)=>{return movie.country==="Japan"})
             setJapaneseMovies(japaneseMovie.slice(0,6))
    ...
    return (
        <>
            ...
            <Shows title="USA" movies={usamovies} />
        </>
    )
}